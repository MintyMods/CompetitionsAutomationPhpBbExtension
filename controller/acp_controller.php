...
/**
 * Minty Competition Automation ACP controller.
 */
class acp_controller
{
	...
	public function display_options()
	{
		...
		$this->language->add_lang('common', 'minty/competitions');

		// Create a form key for preventing CSRF attacks
		add_form_key('minty_competitions_acp');
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (!check_form_key('minty_competitions_acp'))
			{
			...
			if (empty($errors))
			{
				...
				trigger_error($this->language->lang('ACP_COMPETITIONS_SETTING_SAVED') . adm_back_link($this->u_action));
			}
		}
